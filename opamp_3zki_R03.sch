...
y=69.8u
m=1}
C {IP62LIB/CSIO.sym} 2720 -590 0 0 {name=XCN1
model=F_CSIO
c=2.9963046p
x=69.8u
y=69.8u
m=1}
C {IP62LIB/CSIO.sym} 2650 -590 0 0 {name=XCN2
model=F_CSIO
c=2.9963046p
x=69.8u
y=69.8u
...
C {IP62LIB/MN.sym} 2000 -510 0 0 {name=XMCSPDMYN model=NMOS w=12u l=8u m=2 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
