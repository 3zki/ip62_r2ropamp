# 改訂履歴
初版: 実際にテープアウトをしたバージョン。音が出たよ。やったね
R02: フローティングカレントミラーのバイアス回路をBaker本にあるトポロジと同じ構成に修正。電源電圧が充分なので初版でも動くと思います…
R03: CSIO_XCN1, XCN2はゲート・バックゲートを反転させたほうがお作法の観点ではよい。レイアウトは描きにくいけど一応。
